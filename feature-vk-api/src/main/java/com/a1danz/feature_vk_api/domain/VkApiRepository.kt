...
interface VkApiRepository {
    suspend fun getWallUploadServer(ownerId: Long, isGroup: Boolean = false): WallUploadServerDomainModel
    ...
    suspend fun savePhoto(url: String, photo: File, ownerId: Long, isGroup: Boolean = false): SavePhotoResultDomainModel
    suspend fun savePhotos(url: String, photos: List<File>, ownerId: Long, isGroup: Boolean = false): List<SavePhotoResultDomainModel>
}