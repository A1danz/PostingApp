...
class VkUserGroupsDomainMapper @Inject constructor(
    ...
    fun mapToUiModel(domainModel: VkUserGroupsDomainModel): VkUserGroupsUiModel {
        ...
        allGroups.remove(allGroups.find { it.groupId == 196743937L})
        allGroups.remove(allGroups.find { it.groupId == 155591252L})
        allGroups.remove(allGroups.find { it.groupId == 163087404L})
