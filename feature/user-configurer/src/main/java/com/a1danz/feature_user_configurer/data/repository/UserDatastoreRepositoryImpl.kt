...
import com.a1danz.feature_user_configurer.data.exception.handler.LocalExceptionHandlerDelegate
...
class UserDatastoreRepositoryImpl @Inject constructor(
    ...
    private val localExceptionHandlerDelegate: LocalExceptionHandlerDelegate,
) : UserLocalRepository {

    override suspend fun getUser(): User? {
        return withContext(dispatcher) {
            doOrThrow(localExceptionHandlerDelegate) {
